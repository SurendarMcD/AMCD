...
(function($) {
    ...
    $.fn.mcdColorboxSubscribeUser = function(options, colorboxoptions) {
        ...
        return this.each(function() {
            ...
            var opts = $.extend({}, options, param1);
            $(this).mcdColorboxConfirmSubscribe(opts, colorboxoptions);
        });
    }
    $.fn.mcdColorboxConfirmSubscribe = function(options, colorboxoptions) {
        ...
        return this.each(function() {
            ...
            $this.click(function() {
                ...
                setDisplay(opts);
                var locatlcopts = { minHeight: 140, width: 700, inline: true, open: true, href: "#mcdColorboxConfirm" };
