...
function NewCal(pCtrl,pFormat,pShowTime,pTimeMode,pScroller,pHideSeconds)
{
    ...
    //exDateTime=document.forms['contactUsForm'].incidentDate.value;
...
function RenderCal()
{
    ...
    // winCalData+=" var CalId = winMain.document.forms['contactUsForm'].incidentDate; CalId.value=datum;\n";
    ...
    if (Cal.Scroller=="DROPDOWN")
    {
        ...
        for (i = (dtToday.getFullYear() - 5); i <= dtToday.getFullYear() ;i++)
        {
            if (i==Cal.Year)
                SelectStr="Selected";
            else
