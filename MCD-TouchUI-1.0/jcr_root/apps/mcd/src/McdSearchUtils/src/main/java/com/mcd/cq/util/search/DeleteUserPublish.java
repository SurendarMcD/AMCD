...
@Properties({
    @Property( name="service.description",value="Delete User Publish"),
    @Property( name="service.vendor",value="MCD"),
    @Property(name = "sling.servlet.paths", value="/mcd/cq/util/search/DeleteUserPublish"),
...
public class DeleteUserPublish extends SlingAllMethodsServlet {

        
    @Reference
    private org.apache.sling.jcr.api.SlingRepository repository;   
   
    private static final Logger log = LoggerFactory.getLogger(DeleteUserPublish.class);
  ...
  public String lookupUser( String eid){
   ...
   private String getPublishEIDs(String eid){
        ...
        for(int ix=0;ix<serverlist.length;ix++){
            String publishuser=new String(getCQ5Content("http://"+serverlist[ix]+"/content/utility/utility.deleteuser.html?eid="+eid));
