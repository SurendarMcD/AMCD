...
%>
      ...
      <div id="iframeComp" style="max-width:960px; height: 100%; width: 100%">
        <iframe id="<%= frameName %>" name="<%= frameName %>" width="<%= width %>" height="<%= height %>"  frameborder="0" scrolling="<%=showScroll%>"> </iframe>
      </div> <!-- id="iframeComp" -->
