...
<style>
    ...
    .panel-default .panel-heading.active{
        background-image:url('/apps/mcd/components/content/expandableContent/images/down_arrow_accordion.png');
        background-repeat:no-repeat;
        background-position: 98% 50%;
...
<script>
    $('.excontainer.mid-year-conversation .panel-heading').click(function() {
