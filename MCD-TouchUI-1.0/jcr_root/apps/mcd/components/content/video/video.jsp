...
<%
    ...
    String altImageHref = "/images/0.gif";//default splash image location
    ...
    if(currentPath.startsWith("/content/"))currentPath=currentPath.substring(8);
    String shareLink = request.getScheme() + "://" + request.getServerName() + currentPath + ".html";
    //hack for now - ECW 8/20/2010
    if(currentPath.contains("/accessmcd/apmea/au"))
        shareLink = "https://mcsource.mcdonalds.com.au/?frameTarget=https://" + request.getServerName() + currentPath + ".html";
...
if(!"".equals(videoHref))
{
    ...
    {
%>
        <table cellspacing="0" cellpadding="0" height="100%" width="100%" class='<%=backgroundColor%>'>
          <tr height="100%">
            <td width="50%">    
              <table align="right" cellspacing="0" cellpadding="0" height="100%" width="100%">  
                <tr height="240px">
                    <td width="100%" valign="top" align="center">
                        ...
                        <div id="<%=currentNode.getName()%>_videoplayer">
...
<%
        ...
        if(!titleColor.equals("") && !titleColor.equals("default"))titleColor="style='color:"+titleColor+"'";
...
%>
        <script type="text/javascript" language="javascript">        
            $(document).ready(function() { 
                $("a.<%=currentNode.getName()%>_video").mcdColorbox();                    
            });
        </script>
        
            <h3 <%=titleColor %>><%=title%></h3>
