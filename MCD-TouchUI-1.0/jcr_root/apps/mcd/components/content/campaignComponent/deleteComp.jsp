...
<%
    ...
    if(path.indexOf("campaigncomponent_0")>-1) { 
        flag = 1;                
    } else {    
        String nodeName = "";
        ...
        while(nodeIterator.hasNext()){
            ...
            if(childNode.hasNodes()){
                ...
                while(childNodeIterator.hasNext()){
                    ...
                    if(subChildNode.getName().equals("campaigncomponent") && (!subChildNode.getPath().equals(currentNode.getPath()))) {
                        flag = 1;
                        break;                        
                    }
                }
    ...
    if(flag == 1) {                    // if the flag is true , the newly created node has been deleted
