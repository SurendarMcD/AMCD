...
*/       
       ...
       <%if(emailLink){ %> 
        ...
        <%if(prefixAMCD.equals("")) {%>
           <%--  <a href="javascript:void(0)" class="contentlinkbold" onclick="javascript:openEmailWin('<%= currentPagePath %>','','name');return false;"><div class="emailImg"></div></a> --%>
             <a href="javascript:void(0)" class="contentlinkbold" onclick="javascript:openEmailWin('<%= currentPagePath %>','','name');return false;"><IMG src='<%= currentDesign.getPath()%>/images/action_send.gif' align="absMiddle" border=0>  <%=emailText%> </a>
        <%}else{ 
        ...
        %>
            <%-- <a href="javascript:void(0)" class="contentlinkbold" onclick="javascript:openEmailWin('<%= currentPagePath %>','<%=prefixMCD%>','name');return false;"><div class="emailImg"></div></a> --%>
             <a href="javascript:void(0)" class="contentlinkbold" onclick="javascript:openEmailWin('<%= currentPagePath %>','<%=prefixMCD%>','name');return false;"><IMG src='<%= currentDesign.getPath()%>/images/action_send.gif' align="absMiddle" border=0>  <%=emailText%> </a>
        <%} %>
        </td>
       <%} %>
       <%if(getLink){ %> 
    ...
    <a href="javascript:bookmark('<%=currentPage.getTitle()%>','<%=prefixAMCD %>')" class="contentlinkbold"> <IMG src='<%= currentDesign.getPath()%>/images/action_register.gif' align="absMiddle" border=0>  <%=bookMarkText %>
        <%--</div> --%> </a>
        </td>
        <%} %>
       <%if(printLink){ %> 
