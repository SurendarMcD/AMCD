...
while(myChildren.hasNext()){
    ...
    Designer designerObj = slingRequest.getResourceResolver().adaptTo(Designer.class);
    String designName  = designerObj.getDesignPath(child);
    //out.println("Design Name :: " + designName + "<br>");
    String designColor =prop.getProperty(designName+"_responsive");  
    String  strdesignColor = null;
     if(designColor!=null && designColor.contains(","))
     {
      strdesignColor= designColor;
     }
                                                ...
                                                <%
                                                   ...
                                                   {    
                                                    ...
                                                    else if(type.equals("automated"))    
                                                    {
                                                       Page startPage=null;
                                                            if(linkDYK!=null){ 
                                                             startPage= pageManager.getPage(linkDYK);
                                                             
                                                            }else{
                                                             startPage = pageManager.getPage(dykView);
                                                             ...
                                                             Map dykmapSet=dykpageMap;    
                                                             //  Map dykmapSet=dykpageMap.descendingKeySet();                                                                                                                            
                                                               int count=0;
                                                               String dykDesc="";
                                                              
                                                              Iterator<Map.Entry<Date,Page>> entries = dykmapSet.values().iterator();
