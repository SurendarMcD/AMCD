...
<%  
    ...
    String mobileNavDividerText = "New Menu";
    ...
    if(mobileLinksNode!=null){
        if(mobileLinksNode.hasProperty("dividerText")){
            mobileNavDividerText = mobileLinksNode.getProperty("dividerText").getString();
        }
...
%>
{
   ...
   "mobileNavDividerText" : "<%=mobileNavDividerText%>"
}
