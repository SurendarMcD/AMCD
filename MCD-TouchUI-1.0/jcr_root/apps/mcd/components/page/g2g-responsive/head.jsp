...
<script> 
  var linkArray = [];
    ...
    <cq:includeClientLib categories="accessmcd.coreresponsive, accessmcd.componentsresponsive" />   
 
    <%-- YUI --%>
    <script src="/scripts/yui/build/yui/yui-min.js"></script>
    
    <% 
    if (designPath.contains("/etc/designs/mcd/accessmcd/g2g/g2g_rwd")) { %>
        <cq:includeClientLib css="<%=designLib%>" />
        <!--<link rel="stylesheet" type="text/css" href="/etc/designs/mcd/accessmcd/g2g/g2g_rwd/<%=designNode.getName()%>/clientlib/css/bootstrap.min.css"/>
        <link rel="stylesheet" type="text/css" href="/etc/designs/mcd/accessmcd/g2g/g2g_rwd/<%=designNode.getName()%>/clientlib/css/style.css"/>-->
...
<div id="template" style="display:none;"><%=currentPage.getTemplate().getName()%></div>
</head>