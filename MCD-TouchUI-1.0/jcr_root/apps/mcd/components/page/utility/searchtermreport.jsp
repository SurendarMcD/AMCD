...
public void displayForm(javax.servlet.jsp.JspWriter out,HttpServletRequest cqReq)throws IOException{
    ...
    boolean bTopHundred=false;
    if(cqReq.getParameter("bTopHundred")!=null)bTopHundred=true;
    ...
    out.println("<h2 style=\"font-family: Arial;\">Search Query Report: "+startDate+" - "+endDate+"</h2><br>");
    out.println("Search queries appearing 5 or more times during report period. Queries are lower-cased before being logged. Data is only available for the last 90 days.<br><br>");
    ...
    out.println("<b>Top 100</b><INPUT type=checkbox name=\"bTopHundred\" "+ (bTopHundred?"CHECKED":"")+">");
...
public void getSearchReport(javax.servlet.jsp.JspWriter out,HttpServletRequest cqReq,org.apache.sling.api.scripting.SlingScriptHelper sling) throws IOException{
    ...
    try{        
        ...
        String searchTermSql = "select srch_log_qt_tx,count(*),srch_log_mkt_cd,srch_log_lang_cd " +
