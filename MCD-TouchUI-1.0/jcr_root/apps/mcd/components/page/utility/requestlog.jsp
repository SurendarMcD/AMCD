<html>
 <head>
    <title>CQ Request.Log Chart</title>
...
var perfdata=[];
   ...
   <h2>CQ Request Log Chart</h2><!--[if IE]><font color=red>This page is best viewed in FireFox/Chrome.</font><![endif]-->
<!--
<b>Current log:</b><select id="requestLogFile">
<option selected value="request.log">request.log</option> 
<option value="request.log.0">request.log.0</option>
<option value="request.log.1">request.log.1</option>
<option value="request.log.2">request.log.2</option>
<option value="request.log.3">request.log.3</option>
<option value="request.log.4">request.log.4</option>
</select>
-->
...
var datarequesturl='/content/utility/utility.requests.html';
