...
function updateInterface(bAfterResults){
    ...
    if("terms|topclicks|clicks|queries|sessions".indexOf(reporttype)>-1){
        
        $("#divLimit").show();
    }else{
        $("#divLimit").hide();
    }
    if("|topclicks|markets|terms".indexOf("|"+reporttype)>-1){
        $("#divRole").show();
    }else{
        $("#divRole").hide();
    }
...
public void displaySessionsReport(javax.servlet.jsp.JspWriter out, Connection conn, String searchMkt, String role, String startDate, String endDate, boolean bUseArchive, String eid,  String nbrTerms, String docURL, String clickQuery, int rows, boolean bStatsOnly) throws IOException{
    ...
    try{               
        ...
        if(!endDate.equals("")){
            if(!startDate.equals("")){
                searchLogSql +=" srch_log_ts > TO_DATE('"+startDate+"','MM/dd/yyyy')";
            }else{
        ...
        if(!endDate.equals("")){
            if(!startDate.equals("")){
                searchClickSql +=" srch_click_ts > TO_DATE('"+startDate+"','MM/dd/yyyy')";
            }else{
